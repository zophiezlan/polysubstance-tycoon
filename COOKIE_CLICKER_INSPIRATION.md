...
**MEDIUM PRIORITY** (Moderate effort, good returns): 8. Tiered visual indicators for upgrades 9. Signature moves for substances 10. Challenge codes / shareable builds 11. Seasonal events/modifiers 12. Mini-game: Night Market

**LOW PRIORITY** (Nice to have, higher complexity): 13. Multiple minigames 14. Full tech tree visualization 15. Speedrun leaderboards
